...
var preLightCode = require( '../../glsl/templates/pre-light-setup' );
var postLightCode= require( '../../glsl/templates/post-light-setup' );
...
LightSetup.prototype = {
  ...
  getChunks : function(){
    ...
    res.unshift( this.shadowFilter.createProxy() );
    res.unshift( this.depthFormat .createProxy() );
    res.unshift( this.iblShadowing.createProxy() );

    res.push(    this.postChunk .createProxy() );
...
PostChunk.prototype = Object.create( Chunk.prototype );
PostChunk.prototype.constructor = PostChunk;

PostChunk.prototype.genCode = function( slots ){
  code = postLightCode( this )
  slots.add( 'lightsf', code );
};


PostChunk.prototype.getHash = function( ){
  return '0';
};
...
ShadowsChunk.prototype.addLight = function( light ){
  ...
  this._matrices       .set( light.getShadowProjection( this.lightSetup.bounds ), i*16 );
  ...
  if( i===0 ){
    ...
    this.lightSetup.depthFormat.set( hasDepthTex ? 'D_DEPTH' : 'D_RGB' );
  }
